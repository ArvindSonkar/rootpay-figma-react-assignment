...
import AccountSummaryModal from "../../components/AccountSummaryModal/AccountSummaryModal";
...
const AuthLayout = ({ children }: Props) => {
  const { isNewAccountCreated, accountInfo } = useCreateNewAccountContext();
  return (
    <>
